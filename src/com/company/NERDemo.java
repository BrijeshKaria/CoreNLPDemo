...
public class NERDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, Counter<String>> trainweights =  ((CRFClassifier)classifier).topWeights();
        for (Map.Entry<String,  Counter<String>> entry : trainweights.entrySet())
        {
    ...
    */
      ...
      */
           ...
           // ((CRFClassifier) classifier).classifyAndWriteAnswers()
    ...
    /*
    public static void writeModel(String outputPath) throws Exception {
